...
func (o *V1AddressGeocodeOK) Error() string {
	return fmt.Sprintf("[GET /v1/address/geocode][%d] v1AddressGeocodeOK  %+v", 200, o.Payload)
}
func (o *V1AddressGeocodeOK) GetPayload() *models.Geocoding {
	return o.Payload
}

func (o *V1AddressGeocodeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
